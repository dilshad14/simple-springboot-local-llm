...
public class RagChatController {
    ...
    public RagChatController(Assistant assistant,
                             @Qualifier("metadataAwareContentRetriever") ContentRetriever contentRetriever) {
        ...
        try {
            ...
            for (Content content : relevantContents) {
                ...
                if (content.textSegment().metadata() != null) {
                    String chapterName = content.textSegment().metadata().getString("chapter_name");
                    String searchTags = content.textSegment().metadata().getString("search_tags");
            ...
            // Plain Assistant (no ContentRetriever) — context already includes retrieved docs
